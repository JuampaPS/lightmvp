...
export const PORTFOLIO_DATA: PortfolioItem[] = [
  ...
  // TARJETA 2 (Old Index 1): NGBG 25 Video - Fullscreen
  {
    ...
    title: 'NGBG 25 Video',
    mediaType: 'video',
    mediaSrc: '/videos-hero/ngbg25-Mathias Malmø Wide 28.mp4',
    bgColor: '#000000',
    textColor: '#FFFFFF',
  },
  ...
  // TARJETA 6 (Old Index 5): New Vega Video - Fullscreen
  {
    ...
    title: 'Vega Video',
    mediaType: 'video',
    mediaSrc: '/videos-hero/NewVegavideofull.mp4',
    bgColor: '#000000',
    textColor: '#FFFFFF',
  },
  ...
  // TARJETA 8 (Old Index 7): Werkstatt Video - Fullscreen
  {
    ...
    mediaType: 'video',
    mediaSrc: '/videos-hero/werkstattfullvideo.mp4',
    bgColor: '#000000',
    textColor: '#FFFFFF',
  },
  ...
  // TARJETA 10 (Old Index 9): Kayak Video - Fullscreen
  {
    ...
    title: 'Kayak Video',
    mediaType: 'video',
    mediaSrc: '/videos-hero/kayakfullvideo.mp4',
    bgColor: '#000000',
    textColor: '#FFFFFF',
  },
];
